...
public class RcrtEmplyee extends JFrame implements ActionListener
{
	...
	public RcrtEmplyee(String userId)
	{
		...
		roleTF = new JTextField ("General");
		roleTF.setBounds(400, 250, 120, 30);
		roleTF.setBackground(myColor);
		roleTF.setForeground(Color.BLACK);
